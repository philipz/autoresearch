...
def engineer_features(df):
    ...
    X_intra['Intra_EMA30'] = df['Intraday_Ret'].ewm(span=30).mean()
    ...
    X_intra['Intra_EMA10_EMA30_Spread'] = X_intra['Intra_EMA10'] - X_intra['Intra_EMA30']
    ...
    # NetOI longer EMA
    X_intra['NetOI_EMA10'] = df['NetOI_Diff'].ewm(span=10).mean()
