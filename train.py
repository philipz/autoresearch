...
def train_and_evaluate_cv(train_df, val_df):
    ...
    for fold, (tr_idx, te_idx) in enumerate(tscv.split(X_gap_train)):
        ...
        # Gap Regressor
        reg = GradientBoostingRegressor(**GAP_REG_PARAMS)
        ...
        # Intraday Regressor
        intra = GradientBoostingRegressor(**INTRA_REG_PARAMS)
    ...
    gap_reg = GradientBoostingRegressor(**GAP_REG_PARAMS)
    gap_reg.fit(X_gap_train, y_gap_val_train)

    intra_reg = GradientBoostingRegressor(**INTRA_REG_PARAMS)
